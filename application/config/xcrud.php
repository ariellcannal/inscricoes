<?php /** Configuration file; xCRUD v.1.6.26; */
...
class Xcrud_config
{
    ...
    public static $db_time_zone = TIME_ZONE_DB; // database time zone, if you want use system default - leave empty.
    ...
    // editor
    public static $editor_url = '/assets/plugins/ckeditor/ckeditor.js'; // URL path to editor script, if you want to use the visual editor.
    ...
    public static $upload_folder_def = '../../../writable/'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
    public static $not_null_is_required = true; // makes not null fields required
    public static $encode_field_names = true;
    ...
    // map
    public static $default_point = '0,0';
    public static $default_text = 'your_position';
    public static $default_zoom = 16;
    ...
    public static $maps_api_key = 'maps_token';
    ...
    public static $plugins_uri = 'assets/plugins'; // scripts and libraries
    public static $css_uri = 'assets/css'; // css, images
    public static $js_uri = 'assets/js'; // js xcrud
    public static $lang_uri = 'assets/plugins/_language'; // js files
