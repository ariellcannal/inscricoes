...
define('APP_DBPASS', $db[$active_group]['password']);
define('APP_DBNAME', $db[$active_group]['database']);
define('APP_DBPREF', $db[$active_group]['dbprefix']);
define('APP_DBCHARSET', $db[$active_group]['char_set']);
