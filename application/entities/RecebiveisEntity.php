...
class RecebiveisEntity extends _Entity
{
    ...
    protected ?int $creditoUtilizado = null;
    ...
    /**
     * Obtém o crédito utilizado.
     *
     * @return int|null
     */
    public function getCreditoUtilizado(): ?int
    {
        return $this->creditoUtilizado;
    }

    /**
     * Define o crédito utilizado.
     *
     * @param int|null $creditoUtilizado
     * @return self
     */
    public function setCreditoUtilizado(?int $creditoUtilizado): self
    {
