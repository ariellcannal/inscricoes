...
$(document).on("xcrudinit", function() {
	if ($(".xcrud").length) {
		...
		$(".xcrud").off('change', 'input.xcrud-mass-checkbox[type="checkbox"]').on("change", 'input.xcrud-mass-checkbox[type="checkbox"]', function() {
			Xcrud.init_sum_row(this);
		});
